...
public abstract class AbstractExecJavaBase extends AbstractExecMojo {
     ...
     */
    @Parameter
    protected List<String> classpathFilenameExclusions;
     ...
     */
    @Parameter
    protected List<String> forcedJvmPackages;
     ...
     */
    @Parameter
    protected List<String> excludedJvmPackages;
    ...
    protected Function<String, String> resolveVersion(final Function<VersionRangeResult, Object> fn) {
        return ga -> {
    ...
    protected BiConsumer<String, String> propertiesUpdater(final Properties props) {
        return (k, v) -> {
            if (v == null) {
                props.remove(k);
            } else {
     ...
     * @throws MojoExecutionException if a problem happens
     */
    protected void addRelevantPluginDependenciesToClasspath(List<Path> path) throws MojoExecutionException {
